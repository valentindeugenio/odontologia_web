(() => {
    ...
    onReady(() => {
        ...
        setupAccordion({
            ...
            triggerSelector: ".service-toggle",
            panelSelector: ".service-details"
        });
        ...
        const profileData = {
            ...
            musacchio: {
                ...
                highlights: [
                    ...
                    "Planes de cuidado a largo plazo"
                ]
            },
            profesional3: {
        ...
        const openProfile = (profileId) => {
            ...
            profileElements.highlights.replaceChildren(
        ...
        profileDialog?.querySelector(".profile-close")?.addEventListener("click", () => {
            profileDialog.close();
        });

        profileDialog?.querySelector(".profile-booking")?.addEventListener("click", () => {
            profileDialog.close();
        });
